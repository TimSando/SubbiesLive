...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_player_history_game_id'), 'player_history', ['game_id'], unique=False)
    op.create_index(op.f('ix_player_history_player_id'), 'player_history', ['player_id'], unique=False)
    op.create_index(op.f('ix_player_history_team_id'), 'player_history', ['team_id'], unique=False)
