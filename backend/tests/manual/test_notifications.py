...
def main():
    ...
    with Session(engine) as session:
        ...
        if not game:
            print("❌ No games found in the database. Please run ingestion or add mock games first.")
            return
            
        print(f"🔔 Subscribing to Game ID {game.id} or its associated Club/Competition in your PWA to test.")
